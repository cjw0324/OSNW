...
{ 
    AES_KEY key;   
    unsigned char init_key[BLOCK_SIZE]  = {0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,
                                           0x08,0x09,0x0a,0x0b,0x0c,0x0d,0x0e,0x0f}; 
    unsigned char plaintext[BLOCK_SIZE] = {0x00,0x11,0x22,0x33,0x44,0x55,0x66,0x77,
...
void aes_128_decrypt_test()
{
    ...
    unsigned char init_key[BLOCK_SIZE]   = {0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,
                                            0x08,0x09,0x0a,0x0b,0x0c,0x0d,0x0e,0x0f};
    unsigned char ciphertext[BLOCK_SIZE] = {0x69,0xc4,0xe0,0xd8,0x6a,0x7b,0x04,0x30,
